...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-01-2020 a las 02:19:29
...
INSERT INTO `paquete` (`id_paquete`, `nombre`, `precio`) VALUES
(1, 'Paquete 1', '15.00');
...
CREATE TABLE `paquete_servicio` (
  `id_paquete_servicio` int(11) NOT NULL,
  `id_paquete` int(11) NOT NULL,
  `id_servicio` int(11) NOT NULL,
...
INSERT INTO `paquete_servicio` (`id_paquete_servicio`, `id_paquete`, `id_servicio`, `estado`) VALUES
(1, 1, 1, 'Activo');
...
INSERT INTO `servicio` (`id_servicio`, `nombre`, `precio`, `descripcion`, `estado`, `id_categoria`) VALUES
(1, 'Mantenimiento Alfombra', '15.00', 'Mantenimiento General', 'Activo', 1);
...
ALTER TABLE `paquete_servicio`
  ...
  ADD KEY `paquete_servicio_ibfk_1` (`id_paquete`),
  ADD KEY `paquete_servicio_ibfk_2` (`id_servicio`);
...
--
ALTER TABLE `paquete_servicio`
  MODIFY `id_paquete_servicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
